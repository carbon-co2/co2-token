...
contract CarbonToken is ERC20, Ownable, ERC20Detailed {
	address constant carbonianWallet = 0x5B92e4dD06E3E39025DC25baCe3eD62C8989f52E;       // Carbonian (Master Wallet)
    address constant climateChangeProjectWallet = 0x11c6CaB01BBc9802B658Fcf1cA15fD0F1bB337E9;          // Combating Climate Change Projects
	address constant co2CorpWallet = 0x86e4ecb15ed4fe220770a9Ab9195c450eD0B06B3;         // CO2-1-0 (CARBON) CORP
	address constant privateSalesWallet = 0x7973659D9Ca8f0FA8A8aC6beF941149885bC55A0;    // Private Sales (VCs & HNWIs)
	address constant presalesWallet = 0xc8965C1274F445EA0ABe9A1CbCD0BBE3800Af129;        // Pre Sales (Air Drop, Bounty, Community, Etc.)
	address constant workingTeamWallet = 0xc8965C1274F445EA0ABe9A1CbCD0BBE3800Af129;     // Working Team
	address constant boardOfAdvisory = 0xE041F0B8fb73B9902D8df14b1BD494162b4Ac876;       // Board of Advisory
    address constant offsetterWallet = 0x22Bb14665BCf3A9A23071871d434D27e04af6B8e;       // Offsetter
    ...
    constructor() public ERC20Detailed("CARBON-13.4", "CO2", 9) {
